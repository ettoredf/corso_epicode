...
*/
// nuovo array, ciclo, if accedo alla proprietà e verifico (genere -> female) { costruisco un oggetto con i tre dati}
...
for(let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch(character.eye_color) {
    ...
    case "blue-gray":
      ...
      break;
      default:
        console.log("collore occhi non riconosciuto");
  }
}
...
switch(true) {
  case crewMass <= 500:
    ...
    break
    case crewMass > 900  && crewMass <100:
