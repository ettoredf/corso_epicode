...
function splitMe (text = "I love coding") {
...
function deleteOne (text1 = "I love coding", checkText1 = text1) {
  if (checkText1 = text1) {
    return text1 = text1.slice(1)
  }
}
...
function onlyLetters(text2 = "I have 4 dogs") {
  let result = ' ';
...
function getCurrentDay() {
  ...
  return getCurrentDay = "oggi è " + days[day];
}
...
function rollTheDices (numbers = 3) {
  var somma = 0;
  var numExtracted = [];
  for (let i = 0; i < numbers; i++) {
    var diceValue = dice();
    somma += diceValue;
    numExtracted.push(diceValue)
  }
  return {
    somma: somma,
    values: numExtracted
...
function searchAndDivide (str3 = "Lord") {
  var match = [];
  var unmatch = [];
}
...
const myFunction5 = function (list) {
